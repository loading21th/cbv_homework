...
from llmodels.homewore_courseware import Homewore_Courseware
import os 
import json
...
class FileUpView(View):
    ...
    def post(self,request,school_name,class_name):
        upload_path = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))),'uploadfile',school_name,class_name)
...
class FileDownload(View):
    def get(self,request,school_name,class_name,filename):
        fullpath = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))),'uploadfile',school_name,class_name,filename)
